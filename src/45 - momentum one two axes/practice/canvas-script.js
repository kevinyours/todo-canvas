    ...
    for (var i = 0; i < numOfBalls; i++) {
      ...
      for (var j = i + 1; j < numOfBalls; j++) {
        ...
        if (isCollided(ball1, ball2)) {
          ...
          // New Velocity of Ball 1 After Collision
          var vy1 = ((ball1.m - ball2.m) * ball1.vx) / (ball1.m + ball2.m);
          vy1 += (2 * ball2.m * ball2.vx) / (ball1.m + ball2.m);

          // New Velocity of Ball 2 After Collision
          var vy2 = ((ball2.m - ball1.m) * ball2.vx) / (ball2.m + ball1.m);
          vy2 += (2 * ball1.m * ball1.vx) / (ball1.m + ball2.m);
